...
- 選択的仕上げ第2弾（2026-09-23、
  `docs/solver-decomp-sel2-63-100M-2026-09-23.jsonl`、約18k CPU秒）:
  残り6応手以内の13問・74応手を63手/100Mで実行し65解決。
  10問が新規完成（musou-032/051/076/080/083・zukou-032/048/063/093/098）。
  **分解完全証明は計103問**。musou-065は5/6、zukou-031/062は0解決で残留。
  記録の書換えなし。
- musou-065の完成（2026-09-23、
  `docs/solver-decomp-musou065-127-200M-2026-09-23.jsonl`、1332 CPU秒）:
  残り1応手（初手への5i6h+）を127手/200Mで実行し25手でPROVEN
  （2億ノード使い切り際での決着）。**分解完全証明は計104問**。
  zukou-031/062は残留。記録の書換えなし。
...
- 全体証明の300Mラウンド（2026-09-23、
  `docs/solver-dfpn-r6-300M-2026-09-23.jsonl`、約20k CPU秒）:
  最短残件8問中3件PROVEN（zukou-037・055・047。**全体計152件**）。
  musou-065（9手）・musou-001（11手）を含む5件は300MでもUNKNOWN。
  短手数でも高密度局面は決着しないことを確認。記録の書換えなし。
