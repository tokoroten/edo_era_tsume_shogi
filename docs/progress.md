...
| gyokuzu（将棋玉図） | staging drafts | 100 | 1,265 | 100/100（036/092/095/096は持駒なし確定） | 0/100 | 100/100 |
...
- [ ] 盤面 `?` の削減（1,266残・?-free 3件: 008/043/072）。原寸再読・空升確定・持駒基準の先後確定・死駒規定適用で進める（Wave 28で001を?19→18、Wave 31で018を?9→7、Wave 33で073を?22→19、Wave 40で021を?17→11、Wave 41で022を?17→13、Wave 43で069を?18→17、Wave 44で083を?18→17に削減）
