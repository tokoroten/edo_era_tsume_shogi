...
| gyokuzu（将棋玉図） | staging drafts | 100 | 1,595 | 97/100（036は持駒なし確定） | 0/100 | 100/100 |
...
- [ ] 盤面 `?` の削減（1,658 → 0）。原寸再読・空升確定・持駒基準の先後確定で進める
- [ ] 持駒未確定 3件（092, 095, 096）の確定（036は持駒なしで確定済み）
...
- [ ] 無双の NDL 画像 PID 特定・取得（NDLBibID 000001281469）
